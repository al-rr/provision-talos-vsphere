...
# @describe Legacy Talos provisioning helper for govc-based workflows.
# @description This script remains as reference material while Terraform becomes the target path for production Talos VM lifecycle.
...
FACTORY_IMAGE_ID=${FACTORY_IMAGE_ID:=903b2da78f99adef03cbbd4df6714563823f63218508800751560d3bc3557e40}

OVA_NAME="vmware-amd64.ova"
OVA_PATH=${OVA_PATH:="https://factory.talos.dev/image/${FACTORY_IMAGE_ID}/${TALOS_VERSION}/${OVA_NAME}"}
...
# factory.talos.dev/vmware-installer/903b2da78f99adef03cbbd4df6714563823f63218508800751560d3bc3557e40:v1.11.6 
...
upload_ova () {
    ...
    govc datastore.upload -ds ${GOVC_DATASTORE} ${OVA_NAME} talos-${TALOS_VERSION}.ova
}
